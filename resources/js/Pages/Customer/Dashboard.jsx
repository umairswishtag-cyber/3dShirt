            ...
            <div className="min-h-screen bg-[#f8f9fc] text-slate-950">
                ...
                <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
                    <div className="relative flex min-h-[250px] flex-col justify-center overflow-hidden rounded-[28px] border border-indigo-100 bg-[linear-gradient(112deg,#fff_0%,#fbfbff_51%,#eef1ff_100%)] p-7 shadow-[0_14px_38px_rgba(49,46,129,0.06)] sm:p-10">
                        ...
                        <div className="relative z-10 max-w-xl"><span className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-violet-600"><UiIcon name="sparkles" className="h-4 w-4" />Customer workspace</span><h1 className="mt-3 text-4xl font-black tracking-[-0.035em] sm:text-[42px]">Hello, {customer?.name}</h1><p className="mt-3 text-sm leading-6 text-slate-500">Continue a draft or bring a new garment idea to life in your private design workspace.</p><button onClick={() => router.visit('/configurator')} className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition hover:-translate-y-0.5 hover:shadow-xl"><UiIcon name="plus" className="h-4 w-4" />Create new design</button></div>
                    </div>
